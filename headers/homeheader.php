<li id="li1" class="activeli" ><a class="activea" href="https://mrpnl.com/myaccount/"> <div class="liwrap"><img id="img1" src="img/homeimg.png" alt=""> <p id="p1">Home</p></div> </a></li>
<li id="li2"><a href="https://mrpnl.com/myaccount/dca/"><div class="liwrap"><img src="img/confimg.png" style="height: 18px; width: 18px;" alt=""> <p>Configure</p></div> </a>
...
$('.confk').hover(
   function() {
      $('.configurepan').addClass('hoverconf')
   },
   function() {
      $('.configurepan').removeClass('hoverconf')
   }
)

$('.configurepan').hover(
   function() {
      $('.confk a').addClass('whiteaa')
   },
   function() {
      $('.confk a').removeClass('whiteaa')
   }
)
